            ...
            <div className="container mx-auto px-5">
                ...
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className="border-2 border-gray-700 bg-gray-800 shadow-lg hover:shadow-xl transform transition-transform duration-300 ease-in-out hover:scale-105 px-6 py-8 rounded-lg">
                            <svg className="text-gray-400 w-16 h-16 mb-4 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
